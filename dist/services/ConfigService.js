...
var ConfigService = /** @class */ (function () {
     ...
     */
    ConfigService.prototype.syncConfigurations = function () {
        return __awaiter(this, void 0, void 0, function () {
            var configRef;
            var _this = this;
            return __generator(this, function (_a) {
                configRef = this.firebaseDB.ref(constants_1.CONSTANTS.SERVICES.CONFIG);
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        configRef.once("value", function (snapshot) { return __awaiter(_this, void 0, void 0, function () {
                            var configData;
                            return __generator(this, function (_a) {
                                configData = snapshot.val();
                                constants_1.CONSTANTS.GAME = {
                                ...
                                resolve(constants_1.CONSTANTS.GAME);
                                return [2 /*return*/];
                            });
                        }); });
                    })];
